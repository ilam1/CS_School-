...
def makePage(user): #sets up code to determine the factions of new users via test
    faction=getfac(user)
    if faction == "Factionless":
        ans = '<br><a href="test1.py">Take the test!</a><br>'
    else:
        ans = '<br><a href="test2.py">Test your compatibility with other factions!</a><br>'
        ans+= """<br><a href="blog.py">Go to your faction's blog!</a><br>"""
    	ans+="""<br><a href="http://marge.stuy.edu/~irene.lam/finalproject/0607/stuymap.html">Check out the Map of Stuy</a>"""
    return ans
