...
if 'username' in form and 'password' in form: 
    ...
    if authenticate(username,password):
        ...
        #attach a link:
        head += '''<meta http-equiv="refresh" content="0; url=http://marge.stuy.edu/~irene.lam/finalproject/0613/stuymap.py?username=''' + username + '''">'''
    ...
    <h1  style="font-size:450%; text-align:center;">Log in:</h1>
    ...
    <br>
    <input style="font-size:80%;" type="submit" value=" Log In "></p>
