...
#dpercent={}
#mpercent={}
#print float(sum(y.values())/sent2)
def printtable(x,y):
    zcopy = invert(x)
    acopy = invert(y)  
    temp = x.values()
...
#    ans ='<!DOCTYPE html>\n<html>\n <head><title>Tally </title></head>\n <body>\n <h1> Word count </h1>'
    ...
    ans += "<h3> Total sentences </h3> <ul> <li>" + book1.capitalize() + " : " + str(sent1) + "</li><li>" + book2.capitalize() + " : " + str(sent2) + "</li></ul>"
    ans += "<h3> Average words per sentence </h3> <ul> <li>" + book1.capitalize() + " : " + str(float(sum(x.values())/sent1)) + "</li><li>" + book2.capitalize() + " : " + str(float(sum(y.values())/sent2)) + "</li></ul>"
